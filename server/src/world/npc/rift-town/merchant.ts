...
export default class Merchant extends NpcBase {
  ...
  create() {
    ...
    this.set('inquiry', {
      '买卖':
        '杂货商眉开眼笑：「客官要买什么？咱们铺子里东西全，价格公道。药品、食物、杂物，应有尽有。」',
      '散盟':
        '杂货商笑道：「东海散盟嘛，说白了就是做买卖的。从东边运货到西边，再从西边带货回去。散盟的规矩就一条——诚信经商，童叟无欺。」',
      '消息':
        '杂货商压低嗓门：「最近从北边来的商队少了不少，好像是那边出了什么事。货少了价格就高了，你要买什么趁早。」',
      default:
        '杂货商摊摊手：「这个嘛，不是小人能说上话的事情。客官不如看看咱的货？」',
    });
  }
}
